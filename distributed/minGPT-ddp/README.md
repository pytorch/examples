...
This folder contains files adapted from the minGPT repo (https://github.com/karpathy/minGPT) for DDP training. These files are used in the tutorial at https://pytorch.org/tutorials/intermediate/ddp_minGPT.html 
