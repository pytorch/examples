...
def parse_args():
    ...
    parser.add_argument("--use-amp", type=bool, default=False, help="use automatic mixed precision")
    parser.add_argument("--compile-backend", type=str, default="inductor", metavar="BACKEND", help="backend to compile the model with")
    parser.add_argument("--compile-mode", type=str, default="default", metavar="MODE", help="compilation mode")
    parser.add_argument("--save-model", action="store_true", default=False, help="For Saving the current Model")
    parser.add_argument("--data-dir", type=str, default="../data", metavar="DIR", help="path to the data directory")
